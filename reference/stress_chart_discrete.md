...
Creates a visualization of discrete stress states (Low, Medium, High)
over time from wearable data.

## Usage

``` r
stress_chart_discrete(
  .data,
  start = "start_time",
  end = "end_time",
  variable = "variable",
...
object displaying discrete stress states faceted by day.
