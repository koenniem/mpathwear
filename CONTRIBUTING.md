...
This outlines how to propose a change to mpathwear. For a detailed
discussion on contributing to this package, please see tidyverse’s
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("m-path-io/mpathwear", fork = TRUE)`.
...
Code of
Conduct](https://koenniem.github.io/mpathwear/CODE_OF_CONDUCT.md). By
